...
def fill_pdf_fields(input_pdf_path: str, fields_json_path: str, output_pdf_path: str):
    """Fill fillable PDF form fields using values from fields_json_path."""
...
def validation_error_for_field_value(field_info, field_value):
    """Return an error string if field_value is invalid for the field, or None if valid."""
...
def monkeypatch_pydpf_method():
    """Patch pypdf DictionaryObject.get_inherited to handle selection list Opt values correctly."""
