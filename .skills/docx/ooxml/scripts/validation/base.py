...
class BaseSchemaValidator:
            ...
            for file_path in all_files:
                ...
                if extension and extension not in declared_extensions:
                    ...
                    if extension in media_extensions:
                        ...
                        errors.append(
                            f"  {relative_path}: File with extension '{extension}' not declared"
                            f' in [Content_Types].xml - should add: <Default Extension="{extension}"'
    ...
    def validate_against_xsd(self):
        ...
        if self.verbose:
            ...
            new_error_count = len([e for e in new_errors if not e.startswith("    ")]) if new_errors else 0
            print(f"  - With NEW errors: {new_error_count}")
