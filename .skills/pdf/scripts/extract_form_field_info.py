"""Extracts data for fillable PDF form fields and outputs JSON for Claude. See forms.md."""
...
def get_full_annotation_field_id(annotation):
    """Return the fully-qualified field ID for an annotation, matching PdfReader conventions."""
    components = []
    while annotation:
...
def get_field_info(reader: PdfReader):
    """Return a list of fillable PDF field dicts with id, page, type, and type-specific fields."""
...
def write_field_info(pdf_path: str, json_output_path: str):
    """Extract field info from a PDF and write it as JSON to json_output_path."""
